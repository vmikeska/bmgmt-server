...
namespace builder_mgmt_server.Models
{
    ...
    public class TaskChatMessagesModel :
        ChatMessagesModelBase<TaskChatMessagesEntity>,
        ITaskChatMessagesModel
    {        
        public TaskChatMessagesModel(IDbOperations db, IUserModel userModel) : base(db, userModel)
        {
        }
    }
}
